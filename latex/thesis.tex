...
\pubmonth{1}
\publab{Labran nimi?}
\publaben{Cyber Security}
\pubtype{di}
\title{Nix as a declarative solution for embedded security challenges and system administration problems}
\author{Eino Korte}
...
\input{johdanto.tex}
\input{research.tex}
\input{imperative.tex}
\input{embedded.tex}
\input{architecture.tex}
\input{securitystandpoints.tex}
\input{analysis.tex}
\input{further}
\input{conclusion}
\printbibliography
