...
complex setup. This is due to the nature of QuERIES in tandem with
POMDP being able to handle a number of parameters, which is essential
in a larger setting.

Propositions for further work are presented for studying the possibilities of
purely functional and declarative solutions in the embedded
field. The issues in applying QuERIES are also highlighted, and the development of more
