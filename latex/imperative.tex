...
similar in chapter \ref{architecture}, where updates are centralised
...
One benefit from NixOS is its lightweight tendency to enable system
...
shown in figure \ref{userenv} and provide atomic upgrades and
...
following snippet: \begin{lstlisting} { environment.systemPackages = [
      (pkgs.vim_configurable.customize { vimrcConfig.customRc = '' "
...
rollbacks. NixOS handles software providing through something called
