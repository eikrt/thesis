...
% lisää sidosteisuutta tähän chapteriin; spesifisti siten, että
% imperatiiviset systeemit (debian) takaisinkytketään deklaratiivisiin
% poista gentoo sektio% johdata kappaleisiin!!!
% kandoi and hartke! liitä låähdeviitteet enemmään tekstiin
% kappaleiden välille johdatusta
% differnetiation between terms
% kerro mikä on arkkitehtuuri
% paljon perustellaan miksi subsetti queriestat
